...
>>>>>>> 13d30e86 (commit before merging with front)
...
function Divider(_a) {
  ...
  return import_react7.default.createElement("span", { className: "react-datetime-picker__inputGroup__divider" }, children);
}
...
function DayInput(_a) {
  var maxDate = _a.maxDate, minDate = _a.minDate, month = _a.month, year = _a.year, otherProps = __rest3(_a, ["maxDate", "minDate", "month", "year"]);
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  return import_react9.default.createElement(Input, __assign4({ max: maxDay, min: minDay, name: "day" }, otherProps));
}
...
function MonthInput(_a) {
  var maxDate = _a.maxDate, minDate = _a.minDate, year = _a.year, otherProps = __rest4(_a, ["maxDate", "minDate", "year"]);
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  return import_react10.default.createElement(Input, __assign5({ max: maxMonth, min: minMonth, name: "month" }, otherProps));
}
...
=======
  ...
  return import_react11.default.createElement(
    ...
    !value && import_react11.default.createElement("option", { value: "" }, placeholder),
    dates.map(function(date) {
      var month = getMonthHuman(date);
      var disabled2 = month < minMonth || month > maxMonth;
      return import_react11.default.createElement("option", { key: month, disabled: disabled2, value: month }, formatter(locale, date));
>>>>>>> 13d30e86 (commit before merging with front)
    })
  );
}
...
function YearInput(_a) {
  var maxDate = _a.maxDate, minDate = _a.minDate, _b = _a.placeholder, placeholder = _b === void 0 ? "----" : _b, valueType = _a.valueType, otherProps = __rest5(_a, ["maxDate", "minDate", "placeholder", "valueType"]);
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  return import_react12.default.createElement(Input, __assign6({ max: maxYear, min: minYear, name: "year", placeholder, step: yearStep }, otherProps));
}
...
var import_react13 = __toESM(require_react(), 1);
var isBrowser3 = typeof document !== "undefined";
var useIsomorphicLayoutEffect2 = isBrowser3 ? import_react13.useLayoutEffect : import_react13.useEffect;
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  return import_react13.default.createElement(
    ...
    null,
    hasLeadingZero ? import_react13.default.createElement("span", { className: "".concat(className, "__leadingZero") }, "0") : null,
    import_react13.default.createElement("input", { "aria-label": ariaLabel, autoComplete: "off", autoFocus, className: clsx_default("".concat(className, "__input"), "".concat(className, "__").concat(nameForClass || name), hasLeadingZero && "".concat(className, "__input--hasLeadingZero")), "data-input": "true", disabled, inputMode: "numeric", max, min, name, onChange, onFocus: onFocus2, onKeyDown, onKeyPress: makeOnKeyPress2(maxLength), onKeyUp: function(event) {
>>>>>>> 13d30e86 (commit before merging with front)
      esm_default5(event.target);
      if (onKeyUp) {
        onKeyUp(event);
...
function Hour12Input(_a) {
  var amPm = _a.amPm, maxTime = _a.maxTime, minTime = _a.minTime, value = _a.value, otherProps = __rest6(_a, ["amPm", "maxTime", "minTime", "value"]);
  var maxHour = safeMin2(12, maxTime && function() {
...
=======
  return import_react14.default.createElement(Input2, __assign7({ max: maxHour, min: minHour, name: "hour12", nameForClass: "hour", value: value12 }, otherProps));
}
...
function Hour24Input(_a) {
  var maxTime = _a.maxTime, minTime = _a.minTime, otherProps = __rest7(_a, ["maxTime", "minTime"]);
  var maxHour = safeMin2(23, maxTime && getHours(maxTime));
  var minHour = safeMax2(0, minTime && getHours(minTime));
  return import_react15.default.createElement(Input2, __assign8({ max: maxHour, min: minHour, name: "hour24", nameForClass: "hour" }, otherProps));
}
...
function MinuteInput(_a) {
  var hour = _a.hour, maxTime = _a.maxTime, minTime = _a.minTime, _b = _a.showLeadingZeros, showLeadingZeros = _b === void 0 ? true : _b, otherProps = __rest8(_a, ["hour", "maxTime", "minTime", "showLeadingZeros"]);
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  return import_react16.default.createElement(Input2, __assign9({ max: maxMinute, min: minMinute, name: "minute", showLeadingZeros }, otherProps));
}
...
function SecondInput(_a) {
  var hour = _a.hour, maxTime = _a.maxTime, minTime = _a.minTime, minute = _a.minute, _b = _a.showLeadingZeros, showLeadingZeros = _b === void 0 ? true : _b, otherProps = __rest9(_a, ["hour", "maxTime", "minTime", "minute", "showLeadingZeros"]);
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  return import_react17.default.createElement(Input2, __assign10({ max: maxSecond, min: minSecond, name: "second", showLeadingZeros }, otherProps));
}
...
=======
  return import_react18.default.createElement(
    "select",
    { "aria-label": ariaLabel, autoFocus, className: clsx_default("".concat(className, "__input"), "".concat(className, "__").concat(name)), "data-input": "true", "data-select": "true", disabled, name, onChange, onKeyDown, ref: inputRef, required, value: value !== null ? value : "" },
    !value && import_react18.default.createElement("option", { value: "" }, "--"),
    import_react18.default.createElement("option", { disabled: amDisabled, value: "am" }, amLabel),
    import_react18.default.createElement("option", { disabled: pmDisabled, value: "pm" }, pmLabel)
>>>>>>> 13d30e86 (commit before merging with front)
  );
}
...
=======
  return import_react19.default.createElement("input", { "aria-label": ariaLabel, disabled, hidden: true, max: maxDate ? nativeValueParser(maxDate) : void 0, min: minDate ? nativeValueParser(minDate) : void 0, name, onChange, onFocus: stopPropagation, required, step, style: {
>>>>>>> 13d30e86 (commit before merging with front)
    visibility: "hidden",
    position: "absolute",
    zIndex: "-999"
...
=======
var formatDate = getFormatter3(formatDateOptions);
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
var amPmFormatter2 = getFormatter3({ hour: "numeric" });
function getAmPmLabels2(locale) {
  var amString = amPmFormatter2(locale, new Date(2017, 0, 1, 9));
  var pmString = amPmFormatter2(locale, new Date(2017, 0, 1, 21));
...
=======
    import_react20.default.createElement(Divider, { key: "separator_".concat(index) }, element);
...
function DateTimeInput(_a) {
  ...
  var _d = (0, import_react20.useState)(null), amPm = _d[0], setAmPm = _d[1];
  var _e = (0, import_react20.useState)(null), year = _e[0], setYear = _e[1];
  var _f = (0, import_react20.useState)(null), month = _f[0], setMonth = _f[1];
  var _g = (0, import_react20.useState)(null), day = _g[0], setDay = _g[1];
  var _h = (0, import_react20.useState)(null), hour = _h[0], setHour = _h[1];
  var _j = (0, import_react20.useState)(null), minute = _j[0], setMinute = _j[1];
  var _k = (0, import_react20.useState)(null), second = _k[0], setSecond = _k[1];
  var _l = (0, import_react20.useState)(null), value = _l[0], setValue = _l[1];
  var amPmInput = (0, import_react20.useRef)(null);
  var yearInput = (0, import_react20.useRef)(null);
  var monthInput = (0, import_react20.useRef)(null);
  var monthSelect = (0, import_react20.useRef)(null);
  var dayInput = (0, import_react20.useRef)(null);
  var hour12Input = (0, import_react20.useRef)(null);
  var hour24Input = (0, import_react20.useRef)(null);
  var minuteInput = (0, import_react20.useRef)(null);
  var secondInput = (0, import_react20.useRef)(null);
  var _m = (0, import_react20.useState)(isWidgetOpenProps), isWidgetOpen = _m[0], setIsWidgetOpenOpen = _m[1];
  var lastPressedKey = (0, import_react20.useRef)();
...
=======
    return getFormatter3(formatterOptions);
>>>>>>> 13d30e86 (commit before merging with front)
  }();
...
=======
      ...
      return getFormatter3(formatterOptions)(locale, dateToFormat).match(/\d{1,}/);
>>>>>>> 13d30e86 (commit before merging with front)
    }
...
=======
    return import_react20.default.createElement(DayInput, __assign11({ key: "day" }, commonInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
      return import_react20.default.createElement(MonthSelect, __assign11({ key: "month" }, commonInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
    return import_react20.default.createElement(MonthInput, __assign11({ key: "month" }, commonInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
      ariaLabel: monthAriaLabel,
      // eslint-disable-next-line jsx-a11y/no-autofocus
      autoFocus: index === 0 && autoFocus,
...
=======
    return import_react20.default.createElement(YearInput, __assign11({ key: "year" }, commonInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
    return import_react20.default.createElement(Hour12Input, __assign11({ key: "hour12" }, commonInputProps, commonTimeInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
      amPm,
...
=======
    return import_react20.default.createElement(Hour24Input, __assign11({ key: "hour24" }, commonInputProps, commonTimeInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
      ariaLabel: hourAriaLabel,
      // eslint-disable-next-line jsx-a11y/no-autofocus
      autoFocus: index === 0 && autoFocus,
...
=======
    return import_react20.default.createElement(MinuteInput, __assign11({ key: "minute" }, commonInputProps, commonTimeInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
    return import_react20.default.createElement(SecondInput, __assign11({ key: "second" }, commonInputProps, commonTimeInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
    return import_react20.default.createElement(AmPm, __assign11({ key: "ampm" }, commonInputProps, commonTimeInputProps, {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
    return import_react20.default.createElement(NativeInput, { key: "datetime", ariaLabel: nativeInputAriaLabel, disabled, maxDate: maxDate || defaultMaxDate, minDate: minDate || defaultMinDate, name, onChange: onChangeNative, required, value, valueType });
  }
  return (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-static-element-interactions
    import_react20.default.createElement(
...
var allValueTypes = __spreadArray4([], allViews2, true);
var isMinDate = function isMinDate2(props, propName, componentName) {
...
=======
var CalendarIcon = import_react21.default.createElement(
  "svg",
  __assign12({}, iconProps, { className: "".concat(baseClassName, "__calendar-button__icon ").concat(baseClassName, "__button__icon") }),
  import_react21.default.createElement("rect", { fill: "none", height: "15", width: "15", x: "2", y: "2" }),
  import_react21.default.createElement("line", { x1: "6", x2: "6", y1: "0", y2: "4" }),
  import_react21.default.createElement("line", { x1: "13", x2: "13", y1: "0", y2: "4" })
);
var ClearIcon = import_react21.default.createElement(
  "svg",
  __assign12({}, iconProps, { className: "".concat(baseClassName, "__clear-button__icon ").concat(baseClassName, "__button__icon") }),
  import_react21.default.createElement("line", { x1: "4", x2: "15", y1: "4", y2: "15" }),
  import_react21.default.createElement("line", { x1: "15", x2: "4", y1: "4", y2: "15" })
);
var DateTimePicker = function DateTimePicker2(props) {
  var amPmAriaLabel = props.amPmAriaLabel, autoFocus = props.autoFocus, calendarAriaLabel = props.calendarAriaLabel, _a = props.calendarIcon, calendarIcon = _a === void 0 ? CalendarIcon : _a, className = props.className, clearAriaLabel = props.clearAriaLabel, _b = props.clearIcon, clearIcon = _b === void 0 ? ClearIcon : _b, _c = props.closeWidgets, shouldCloseWidgetsOnSelect = _c === void 0 ? true : _c, dataTestid = props["data-testid"], dayAriaLabel = props.dayAriaLabel, dayPlaceholder = props.dayPlaceholder, disableCalendar = props.disableCalendar, disableClock = props.disableClock, disabled = props.disabled, format = props.format, hourAriaLabel = props.hourAriaLabel, hourPlaceholder = props.hourPlaceholder, id = props.id, _d = props.isCalendarOpen, isCalendarOpenProps = _d === void 0 ? null : _d, _e = props.isClockOpen, isClockOpenProps = _e === void 0 ? null : _e, locale = props.locale, maxDate = props.maxDate, _f = props.maxDetail, maxDetail = _f === void 0 ? "minute" : _f, minDate = props.minDate, minuteAriaLabel = props.minuteAriaLabel, minutePlaceholder = props.minutePlaceholder, monthAriaLabel = props.monthAriaLabel, monthPlaceholder = props.monthPlaceholder, _g = props.name, name = _g === void 0 ? "datetime" : _g, nativeInputAriaLabel = props.nativeInputAriaLabel, onCalendarClose = props.onCalendarClose, onCalendarOpen = props.onCalendarOpen, onChangeProps = props.onChange, onClockClose = props.onClockClose, onClockOpen = props.onClockOpen, onFocusProps = props.onFocus, onInvalidChange = props.onInvalidChange, _h = props.openWidgetsOnFocus, openWidgetsOnFocus = _h === void 0 ? true : _h, required = props.required, secondAriaLabel = props.secondAriaLabel, secondPlaceholder = props.secondPlaceholder, shouldCloseWidgets = props.shouldCloseWidgets, shouldOpenWidgets = props.shouldOpenWidgets, showLeadingZeros = props.showLeadingZeros, value = props.value, yearAriaLabel = props.yearAriaLabel, yearPlaceholder = props.yearPlaceholder, otherProps = __rest10(props, ["amPmAriaLabel", "autoFocus", "calendarAriaLabel", "calendarIcon", "className", "clearAriaLabel", "clearIcon", "closeWidgets", "data-testid", "dayAriaLabel", "dayPlaceholder", "disableCalendar", "disableClock", "disabled", "format", "hourAriaLabel", "hourPlaceholder", "id", "isCalendarOpen", "isClockOpen", "locale", "maxDate", "maxDetail", "minDate", "minuteAriaLabel", "minutePlaceholder", "monthAriaLabel", "monthPlaceholder", "name", "nativeInputAriaLabel", "onCalendarClose", "onCalendarOpen", "onChange", "onClockClose", "onClockOpen", "onFocus", "onInvalidChange", "openWidgetsOnFocus", "required", "secondAriaLabel", "secondPlaceholder", "shouldCloseWidgets", "shouldOpenWidgets", "showLeadingZeros", "value", "yearAriaLabel", "yearPlaceholder"]);
  var _j = (0, import_react21.useState)(isCalendarOpenProps), isCalendarOpen = _j[0], setIsCalendarOpen = _j[1];
  var _k = (0, import_react21.useState)(isClockOpenProps), isClockOpen = _k[0], setIsClockOpen = _k[1];
  var wrapper = (0, import_react21.useRef)(null);
  var calendarWrapper = (0, import_react21.useRef)(null);
  var clockWrapper = (0, import_react21.useRef)(null);
...
<<<<<<< HEAD
  var closeCalendar = (0, import_react41.useCallback)(function(_a4) {
    var reason = _a4.reason;
=======
  var closeCalendar = (0, import_react21.useCallback)(function(_a2) {
    var reason = _a2.reason;
>>>>>>> 13d30e86 (commit before merging with front)
...
<<<<<<< HEAD
  var closeClock = (0, import_react41.useCallback)(function(_a4) {
    var reason = _a4.reason;
=======
  var closeClock = (0, import_react21.useCallback)(function(_a2) {
    var reason = _a2.reason;
>>>>>>> 13d30e86 (commit before merging with front)
    if (shouldCloseWidgets) {
...
<<<<<<< HEAD
  var closeWidgets = (0, import_react41.useCallback)(function(_a4) {
    var reason = _a4.reason;
=======
  var closeWidgets = (0, import_react21.useCallback)(function(_a2) {
    var reason = _a2.reason;
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  var onOutsideAction = (0, import_react21.useCallback)(function(event) {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  var handleOutsideActionListeners = (0, import_react21.useCallback)(function(shouldListen) {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
    return import_react21.default.createElement(
      ...
      import_react21.default.createElement(DateTimeInput, __assign12({}, ariaLabelProps, placeholderProps, {
        // eslint-disable-next-line jsx-a11y/no-autofocus
        autoFocus,
...
=======
      clearIcon !== null && import_react21.default.createElement("button", { "aria-label": clearAriaLabel, className: "".concat(baseClassName, "__clear-button ").concat(baseClassName, "__button"), disabled, onClick: clear, onFocus: stopPropagation, type: "button" }, typeof clearIcon === "function" ? import_react21.default.createElement(clearIcon) : clearIcon),
      calendarIcon !== null && !disableCalendar && import_react21.default.createElement("button", { "aria-label": calendarAriaLabel, className: "".concat(baseClassName, "__calendar-button ").concat(baseClassName, "__button"), disabled, onClick: toggleCalendar, onFocus: stopPropagation, type: "button" }, typeof calendarIcon === "function" ? import_react21.default.createElement(calendarIcon) : calendarIcon)
>>>>>>> 13d30e86 (commit before merging with front)
    );
  }
...
=======
    var calendarClassName = props.calendarClassName, dateTimePickerClassName = props.className, dateTimePickerMaxDetail = props.maxDetail, onChangeProps2 = props.onChange, portalContainer = props.portalContainer, value2 = props.value, calendarProps = __rest10(props, ["calendarClassName", "className", "maxDetail", "onChange", "portalContainer", "value"]);
    var className2 = "".concat(baseClassName, "__calendar");
    var classNames = clsx_default(className2, "".concat(className2, "--").concat(isCalendarOpen ? "open" : "closed"));
    var calendar = import_react21.default.createElement(esm_default2, __assign12({ className: calendarClassName, onChange: function(value3) {
      return onDateChange(value3);
    }, value: value2 }, calendarProps));
    return portalContainer ? (0, import_react_dom2.createPortal)(import_react21.default.createElement("div", { ref: calendarWrapper, className: classNames }, calendar), portalContainer) : import_react21.default.createElement(
      esm_default4,
      null,
      import_react21.default.createElement("div", { ref: function(ref) {
>>>>>>> 13d30e86 (commit before merging with front)
...
<<<<<<< HEAD
    ...
    return portalContainer ? (0, import_react_dom2.createPortal)(import_react41.default.createElement("div", { ref: clockWrapper, className: classNames }, clock), portalContainer) : import_react41.default.createElement(
      ...
      import_react41.default.createElement("div", { ref: function(ref) {
=======
    var clockClassName = props.clockClassName, dateTimePickerClassName = props.className, _a2 = props.maxDetail, maxDetail2 = _a2 === void 0 ? "minute" : _a2, onChange2 = props.onChange, portalContainer = props.portalContainer, value2 = props.value, clockProps = __rest10(props, ["clockClassName", "className", "maxDetail", "onChange", "portalContainer", "value"]);
    var className2 = "".concat(baseClassName, "__clock");
    var classNames = clsx_default(className2, "".concat(className2, "--").concat(isClockOpen ? "open" : "closed"));
    var valueFrom = (Array.isArray(value2) ? value2 : [value2])[0];
    var maxDetailIndex = allViews3.indexOf(maxDetail2);
    var clock = import_react21.default.createElement(esm_default3, __assign12({ className: clockClassName, renderMinuteHand: maxDetailIndex > 0, renderSecondHand: maxDetailIndex > 1, value: valueFrom }, clockProps));
    return portalContainer ? (0, import_react_dom2.createPortal)(import_react21.default.createElement("div", { ref: clockWrapper, className: classNames }, clock), portalContainer) : import_react21.default.createElement(
      esm_default4,
      null,
      import_react21.default.createElement("div", { ref: function(ref) {
>>>>>>> 13d30e86 (commit before merging with front)
...
=======
  var eventProps = (0, import_react21.useMemo)(function() {
    return makeEventProps(otherProps);
  }, [otherProps]);
  return import_react21.default.createElement(
    "div",
    __assign12({ className: clsx_default(baseClassName, "".concat(baseClassName, "--").concat(isCalendarOpen || isClockOpen ? "open" : "closed"), "".concat(baseClassName, "--").concat(disabled ? "disabled" : "enabled"), className), "data-testid": dataTestid, id }, eventProps, { onFocus: onFocus3, ref: wrapper }),
>>>>>>> 13d30e86 (commit before merging with front)
    renderInputs(),
    renderCalendar(),
    renderClock()
...
=======
var isValue = import_prop_types4.default.oneOfType([import_prop_types4.default.string, import_prop_types4.default.instanceOf(Date)]);
...
DateTimePicker.propTypes = {
  ...
  calendarAriaLabel: import_prop_types4.default.string,
  calendarClassName: import_prop_types4.default.oneOfType([import_prop_types4.default.string, import_prop_types4.default.arrayOf(import_prop_types4.default.string)]),
  calendarIcon: import_prop_types4.default.oneOfType([import_prop_types4.default.node, import_prop_types4.default.func]),
  className: import_prop_types4.default.oneOfType([import_prop_types4.default.string, import_prop_types4.default.arrayOf(import_prop_types4.default.string)]),
  ...
  closeWidgets: import_prop_types4.default.bool,
  "data-testid": import_prop_types4.default.string,
  dayAriaLabel: import_prop_types4.default.string,
  dayPlaceholder: import_prop_types4.default.string,
  disableCalendar: import_prop_types4.default.bool,
  ...
  isCalendarOpen: import_prop_types4.default.bool,
  isClockOpen: import_prop_types4.default.bool,
  locale: import_prop_types4.default.string,
  maxDate: isMaxDate,
  ...
  monthAriaLabel: import_prop_types4.default.string,
  monthPlaceholder: import_prop_types4.default.string,
  name: import_prop_types4.default.string,
  nativeInputAriaLabel: import_prop_types4.default.string,
  onCalendarClose: import_prop_types4.default.func,
  onCalendarOpen: import_prop_types4.default.func,
  ...
  openWidgetsOnFocus: import_prop_types4.default.bool,
  ...
  value: isValueOrValueArray,
  yearAriaLabel: import_prop_types4.default.string,
  yearPlaceholder: import_prop_types4.default.string
};
if (isBrowser4) {
  DateTimePicker.propTypes.portalContainer = import_prop_types4.default.instanceOf(HTMLElement);
>>>>>>> 13d30e86 (commit before merging with front)
}
